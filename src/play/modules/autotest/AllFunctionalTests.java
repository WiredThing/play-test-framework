...
@RunWith(AllFunctionalTests.class)
public class AllFunctionalTests extends ParentRunner<Runner> {

	private List<Runner> runners;

	public AllFunctionalTests(Class<?> testClass) throws Exception {
		super(testClass);
		if (!Play.started) {
		...
		List<Class> tests = TestEngine.allFunctionalTests();
